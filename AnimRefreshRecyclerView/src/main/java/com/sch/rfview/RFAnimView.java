 ...
 * 刷新的动画
 */
public class RFAnimView extends View {
    ...
    private final int SPEED = 5; // 速度

    private boolean isShow;

    public RFAnimView(Context context) {
        this(context, null);
    }

    public RFAnimView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RFAnimView(Context context, AttributeSet attrs, int defStyleAttr) {
